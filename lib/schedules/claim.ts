...
export type ClaimDecision = 'already_sent' | 'skipped' | 'takeover'

/** What to do with the row that already exists for (schedule, run): sent →
 *  never again; a claim younger than the stale window → someone is on it;
 *  failed / skipped / a stale claim → take it over. */
